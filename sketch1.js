...
function setup() {
  ...
  // //cnv.style("z-index", "1"); // Moves it on top of the background
  // cnv.position(0, 0); // Ensures it covers the entire screen
  // cnv.style("z-index", "1000"); // Moves canvas to the top layer
  // cnv.style("position", "absolute"); // Prevents default static positioning
  // cnv.style("top", "0");
  // cnv.style("left", "0");
  ...
  //vscale = width / 40;
  if (width < height) {
    vscale = width / 35; // vScale tied to window width so it can work on phone and computer
